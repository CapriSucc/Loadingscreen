...
die ("<h1>Something went wrong, read below to solve it</h1>It seems as if you have not correctly done the URL so the loading screen would work. Have you read the README file? I take it you have not! Please choose one of the following options<br><br>
	 ...
	 But do note that <i>server name</i> and <i>server gamemode</i> will not be shown as that is shown when the user is loading with javascript, the map is currently set to gm_fork: <a href='$loadingurl?steamid=76561198051229287'>$loadingurl?steamid=76561198051229287</a><br><br>
